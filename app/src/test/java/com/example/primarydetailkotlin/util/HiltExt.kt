package com.example.primarydetailkotlin.util
...
import com.example.primarydetailkotlin.HiltTestActivity
import com.example.primarydetailkotlin.R

inline fun <reified T : Fragment> launchFragmentInHiltContainer(
    fragmentArgs: Bundle? = null,
    @StyleRes themeResId: Int = R.style.Theme_PrimaryDetailKotlin,
